...
#include "../filemanager/createfile.h"
...
struct qt_meta_stringdata_createfile_t {
    QByteArrayData data[3];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_createfile_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_createfile_t qt_meta_stringdata_createfile = {
    {
QT_MOC_LITERAL(0, 0, 10), // "createfile"
QT_MOC_LITERAL(1, 11, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "createfile\0on_pushButton_clicked\0"
};
...
const QMetaObject createfile::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_createfile.data,
      qt_meta_data_createfile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *createfile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_createfile.stringdata0))
